...
Public Class TEstados
    Public Shared Function Add(value As Models.TEstados) As Integer
        Using cmd As New SqlCommand("dbo.TEstados_Add", Connection.Cnn)
    ...
    Public Shared Function Edit(value As Models.TEstados) As Integer
        Using cmd As New SqlCommand("dbo.TEstados_Edit", Connection.Cnn)
            cmd.CommandType = CommandType.StoredProcedure
			         cmd.Parameters.Add(New SqlParameter("@TEstadoId", value.TEstadoId))
         cmd.Parameters.Add(New SqlParameter("@DscTEstado", value.DscTEstado))
         cmd.Parameters.Add(New SqlParameter("@Habilitado", value.Habilitado))
    ...
    Public Shared Function Delete(value As String) As Integer
        Using cmd As New SqlCommand("dbo.TEstados_Delete", Connection.Cnn)
            cmd.CommandType = CommandType.StoredProcedure
    ...
    Public Shared Function GetById(value As String) As Models.TEstados
        Using cmd As New SqlCommand("dbo.TEstados_GetById", Connection.Cnn)
            cmd.CommandType = CommandType.StoredProcedure
            cmd.Parameters.Add(New SqlParameter("@value", value))
            Dim drResultado As IDataReader = Nothing
            Dim registro As Models.TEstados = New Models.TEstados
            ...
            Try
                ...
                registro.DscTEstado = CType(drResultado("DscTEstado"), Integer)
    ...
    Public Shared Function GetByGUID(value As String) As Models.TEstados
        Using cmd As New SqlCommand("dbo.TEstados_GetByGUID", Connection.Cnn)
            cmd.CommandType = CommandType.StoredProcedure
            cmd.Parameters.Add(New SqlParameter("@value", value))
            Dim drResultado As IDataReader = Nothing
            Dim registro As Models.TEstados = New Models.TEstados
    ...
    Public Shared Function GetAll() As List(Of Models.TEstados)
        Using cmd As New SqlCommand("dbo.TEstados_GetAll", Connection.Cnn)

            cmd.CommandType = CommandType.StoredProcedure
            Dim drResultado As IDataReader = Nothing
            Dim registros As List(Of Models.TEstados) = New List(Of Models.TEstados)
            ...
            Try
                ...
                While drResultado.Read
                    Dim registro = New Models.TEstados
                                    registro.TEstadoId = CType(drResultado("TEstadoId"), Integer)
                registro.DscTEstado = CType(drResultado("DscTEstado"), Integer)
                registro.Habilitado = CType(drResultado("Habilitado"), Integer)
                registro.UserId = CType(drResultado("UserId"), Integer)
